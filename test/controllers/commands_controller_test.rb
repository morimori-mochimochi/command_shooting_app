...
class CommandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create command" do
    assert_difference("Command.count") do
      post commands_url, params: { command: { body: @command.body, description: @command.description } }
    end
  ...
  test "should update command" do
    patch command_url(@command), params: { command: { body: @command.body, description: @command.description } }
